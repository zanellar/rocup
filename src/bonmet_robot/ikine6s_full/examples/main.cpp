...
static void main_ikine6s_full()
{
  ...
  // Initialize function 'ikine6s_full' input arguments.
  // Initialize function input argument 'T'.
  // Initialize function input argument 'q_init'.
  // Call the entry-point 'ikine6s_full'.
  argInit_4x4_real_T(dv4);
  argInit_6x1_real_T(dv5);
  ikine6s_full(dv4, dv5, out);
}
