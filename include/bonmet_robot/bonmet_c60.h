...
#ifndef BONMETSMARTSIX_H
#define BONMETSMARTSIX_H
...
namespace bonmet_robot {
    ...
    public:
        ...
        IKSolutionState ik_cf(KDL::Frame &target_frame, std::vector<double> &q_in, std::vector<double> &q_out);
